...
(
    ...
    UNIQUE KEY `unique_user_id_travel_id` (`creator_id`, `travel_id`,`recipient_id`),
    CONSTRAINT `fk_feedbacks_users` FOREIGN KEY (`recipient_id`) REFERENCES `users` (`id`),
CONSTRAINT
`feedback_travels_travel_id_fk` FOREIGN KEY (`travel_id`) REFERENCES `travels` (`id`),
